...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax, defaults,
        validateWords, lengthRange, lengthLimit, pattern, alertTxt, data,mycust
        email_illegalChars = /[\(\)\<\>\,\;\:\\\/\"\[\]]/,
    ...
    */
    mark = function( field, text ){
        ...
        if (mycust) {
            field.parent().addClass('form-required');
            field.next(".required-msg").html(text);
        }
    ...
    */
    unmark = function( field ){
        ...
        if (mycust) {
            field.parent().removeClass('form-required');
        }
